const { spawnitems } = require('../arandomspawn.json');
...
module.exports = {
	...
	execute(message) {
		...
		const embed = {
			...
			'thumbnail': {
				'url': 'https://brdrop.com/apexlegends-files/images/' + `${image}` + '.png',
			},
			'image': {
				'url': 'https://brdrop.com/apexlegends-files/images/' + `${image}` + '.png',
			},
			...
			'author': {
				...
				'icon_url': 'https://brdrop.com/apexlegends-files/images/fbimage2.png',
			},
		};
