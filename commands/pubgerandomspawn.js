...
const { spawnitems } = require('../json/pubgkrandomspawn.json');
...
module.exports = new Command({
	...
	usage: 'Display PUBG Erangel Drop',
	type: 'BOTH',
	slashCommandOptions: [],
	...
	async run(message) {
		...
		embed
			...
			.setColor(14274056)
			.setThumbnail('https://brdrop.com/pub_files/images/' + `${image}` + '.png')
			.setTimestamp()
			.setImage(
				'https://brdrop.com/pub_files/images/' + `${image}` + '.png',
			)
